        ...
        return (
          <div className="integration-wizard__step">
            <h1 className="integration-wizard__title">
              {hasExistingIntegrations ? "Create integration" : "Create your first integration"}
            </h1>
        ...
        return (
          <div className="integration-wizard__step">
            ...
            <p className="integration-wizard__subtitle">
              ...
              <a href="#" className="integration-wizard__link">Learn more</a>
            </p>
            ...
            <p className="integration-wizard__warning">
              ...
              <a href="#" className="integration-wizard__link">support</a> request.
            </p>
          </div>
        );
        ...
        <div className="integration-wizard__actions">
          <div className="integration-wizard__next-section">
            {currentStep < 3 ? (
              <Button
                variant="primary"
                onClick={nextStep}
                className="integration-wizard__next-btn"
              >
                Next step
          ...
          {currentStep === 2 && (
            <div className="integration-wizard__skip-section">
              <button 
                className="integration-wizard__skip-btn"
                onClick={skipStep}
              >
                Skip
                <Icon name="right-arrow" size="sm" />
